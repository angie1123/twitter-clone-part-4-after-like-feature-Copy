...
export default function ProfilePostCard({ content, postId }) {
  ...
  // useEffect(() => {
  //   fetch(//fetch specific post like data with postId
  //     `https://d4536fab-57d9-4188-a9ff-87fccd2cee3b-00-1viuxdabp1ge9.spock.replit.dev/likes/posts/${postId}`
  //   )
  //     .then((response) => response.json())
  //     .then((data) =>
  //     //the response return an array of username,so in here the data.length is array length of username
